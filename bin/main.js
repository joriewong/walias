...
require$$2__default['default'].inherits(Command, EventEmitter);
...
Command.prototype.executeSubCommand = function(argv, args, unknown) {
  ...
  var bin = basename(f, path__default['default'].extname(f)) + '-' + args[0];

  // In case of globally installed, get the base dir where executable
  //  subcommand file should be located at
  var baseDir;

  var resolvedLink = fs__default['default'].realpathSync(f);
...
var repository = {
	type: "git",
	url: "git+https://github.com/joriewong/walias.git"
};
var keywords = [
	"alias"
];
...
var license = "MIT";
var bugs = {
	url: "https://github.com/joriewong/walias/issues"
};
var homepage = "https://github.com/joriewong/walias#readme";
var devDependencies = {
